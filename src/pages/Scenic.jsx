...
const filters = [
  { img: natureImg, title: '自然風景類' },
  { img: factoryImg, title: '觀光工廠類' },
  { img: playImg, title: '遊憩類' },
  { img: farmingImg, title: '休閒農業類' },
  { img: ecologyImg, title: '生態類' },
  { img: hotspringImg, title: '溫泉類' },
  { img: historicImg, title: '古蹟類' },
];
...
export default function Scenic() {
  ...
  function replaceUrl() {
    history.replace(`/scenic?city=${optionValue}&q=${keyword}`);
  }
