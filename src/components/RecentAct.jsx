    ...
    <section className='mb-9'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 lg:gap-x-7.5 gap-y-4 lg:gap-y-3'>
        <div className='activity_card flex lg:border lg:border-second-229 lg:rounded-xl lg:overflow-hidden'>
          <img
            className='w-22.5 h-15 lg:w-40 lg:h-40 rounded-lg lg:rounded-none flex-grow-0 flex-shrink-0 self-center'
            src='https://images.unsplash.com/photo-1549534077-1b4f31dd59ea?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=200&q=80'
            alt='日月潭花火音樂嘉年華'
          />
          <div className='flex-grow flex flex-col lg:bg-second-249 pl-4 pr-1 lg:px-7.5 lg:py-4'>
            <div className='lg:flex-grow'>
              ...
              <h5 className='text-second-47 font-bold lg:text-1.5xl lg:leading-8 ellipsis-2 mb-1/4 lg:mb-0'>2021 日月潭花火音樂嘉年華</h5>
            </div>
